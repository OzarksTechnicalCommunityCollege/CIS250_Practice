# CSC160_Practice
Welcome to GitHub! The page you are on now is called a repository (think of it like a fancy folder). Each time you begin an assignemnt, a new repository will be create for you based off of the instructor's template repository. The URL of the page is what you will turn in for your submission. <br>
...
3. Create file: This will be the "starter" file for each assignment. You should open this in IDLE and complete it on your local computer. <br>

The practice assignment is very simple. All that you need to do is add a single line to the starter file that reads: <br>
print('Wow, I''m learning!') <br>
